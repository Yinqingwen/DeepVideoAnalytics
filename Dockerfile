...
WORKDIR "/bin/"
RUN wget https://github.com/FFmpeg/FFmpeg/releases/download/n3.0/ffmpeg-3.0.tar.xz
#https://johnvansickle.com/ffmpeg/releases/ffmpeg-release-amd64-static.tar.xz 
#https://www.dropbox.com/s/bjyzb8hytdwp2tp/ffmpeg-release-64bit-static.tar.xz
RUN tar xvfJ ffmpeg-3.0.tar.xz 
...
RUN pip install --no-cache-dir https://download.pytorch.org/whl/cu90/torch-0.3.1-cp27-cp27mu-linux_x86_64.whl
